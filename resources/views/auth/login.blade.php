...
<head>
    ...
    <title>Login — Hulkam Caffe</title>
    ...
    <style>
        body {
            ...
            color: #E9DECF;
            background-image:
                radial-gradient(800px 500px at 10% -10%, rgba(224,162,99,0.10), transparent 60%),
                radial-gradient(700px 400px at 100% 110%, rgba(147,165,107,0.07), transparent 60%);
        }
        .card-kosmos {
            background: #1B140E;
            border-radius: 24px;
...
<body class="flex items-center justify-center min-h-screen bg-kosmos-bg px-4 py-8 relative overflow-hidden">
    <!-- Decorative background elements -->
    <div class="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
        <div class="absolute -top-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-kosmos-primary/10 blur-3xl"></div>
        <div class="absolute -bottom-[20%] -right-[10%] w-[50%] h-[50%] rounded-full bg-kosmos-sage/10 blur-3xl"></div>
    </div>

    <div class="card-kosmos p-8 md:p-10 w-full max-w-md relative z-10">
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-serif font-bold text-kosmos-brown">Selamat Datang</h1>
            <p class="text-kosmos-muted mt-2 text-sm">Masuk ke akun Hulkam Caffe Anda</p>
        </div>
        ...
        <p class="text-center text-kosmos-muted text-sm mt-8 border-t border-kosmos-border pt-6">
            Belum punya akun? <a href="{{ route('register') }}" class="text-kosmos-primary font-bold hover:text-kosmos-dark transition-colors">Daftar di sini</a>
        </p>
